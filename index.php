                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>1086 Stockert Hollow Road, Texas</p>
                                    <h5>Phone: +1 9297329872</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Partner with us</h5>
                                   <p>Join thousands of restaurants already growing their business with us! Partner with us to reach more customers, boost your sales, and offer a convenient delivery experience.</p>
                                </div>
                    </div>
                </div>
